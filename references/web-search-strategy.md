...
> 本文件定义 `food-social-content` Skill 在联网模式下的搜索词模板、调用顺序、失败回退机制。
> 适用领域：美食探店 / 餐厅 / 必吃
...
```
/food-social-content 目的地=稻城亚丁 web=auto
/food-social-content 目的地=稻城亚丁 web=true
/food-social-content 目的地=稻城亚丁 web=false
```
...
*版本：v1.0 | 维护：food-social-content*
