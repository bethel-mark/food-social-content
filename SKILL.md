...
完全套用 [`travel-social-content`](https://github.com/YOUR_USERNAME/travel-social-content) 的 Skill 架构（同一作者 / 同套标准），但主题从「旅游打卡」改为「美食探店」。
...
> 本 skill 完全复刻 [`travel-social-content`](https://github.com/YOUR_USERNAME/travel-social-content) 架构。如发现两份有显著差异，欢迎提 Issue。
